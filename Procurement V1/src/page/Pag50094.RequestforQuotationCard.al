page 50094 "Request for Quotation Card"
{
    ...
    layout
    {
        area(content)
        {
            ...
            part("Request for Quatation Lines"; 50095)
            {
                SubPageLink = "Document No." = FIELD("No.");
                ToolTip = 'Request for Quotation Line';
                ApplicationArea = All;
            }
            part("Procurement Requirements"; 50077)
            {
                SubPageLink = "Document No." = FIELD("No.");
                ApplicationArea = All;
            }
        ...
        area(creation)
        {
            ...
            action("Create Quotes")
            {
                ...
                begin
                    ...
                    IF CONFIRM('Are you sure you want to create a purchase quotes from this requisition?') THEN
                        ProcurementManagement.CreatePurchaseQuotes(Rec);
                end;
            }
            action("Create PO")
            {
                ...
                begin
                    ...
                    IF CONFIRM('Are you sure you want to create a purchase order from this RFQ?') THEN
                        ProcurementManagement.CreatePurchaseOrderRFQ(Rec);
                end;
            }
            ...
            group("Report")
            {
                ...
                action("Print Request for Quotation")
                {
                    ...
                    var
                        ...
                        RequestforQuotationVendors2: Record 50051;
                    begin

                        RequestforQuotationVendors.RESET;
                        RequestforQuotationVendors.SETRANGE(RequestforQuotationVendors."RFQ Document No.", Rec."No.");
                        IF RequestforQuotationVendors.FINDFIRST THEN BEGIN
                            REPEAT
                                RequestforQuotationVendors2.RESET;
                                RequestforQuotationVendors2.SETRANGE("RFQ Document No.", RequestforQuotationVendors."RFQ Document No.");
                                RequestforQuotationVendors2.SETRANGE("Vendor No.", RequestforQuotationVendors."Vendor No.");
                                IF RequestforQuotationVendors2.FINDFIRST THEN
                                    REPORT.RUNMODAL(REPORT::"Request for Quatation Report", TRUE, FALSE, RequestforQuotationVendors2);
