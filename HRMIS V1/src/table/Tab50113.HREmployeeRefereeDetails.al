table 50113 "HR Employee Referee Details"
{
    ...
    fields
    {
        ...
        field(8; "Post Code"; Code[20])
        {
            ...
            /*  TableRelation = IF ("Country/Region Code" = CONST('')) "Post Code"
             ...
             trigger OnLookup()
             begin
                 PostCode.LookupPostCode("City/Town", "Post Code", County, "Country/Region Code");
             end;

             trigger OnValidate()
             begin
                 PostCode.ValidatePostCode("City/Town", "Post Code", County, "Country/Region Code", (CurrFieldNo <> 0) AND GUIALLOWED);
             end; */
        }
        ...
        field(12; "City/Town"; Text[30])
        {
            ...
            trigger OnValidate()
            begin
                PostCode.ValidateCity("City/Town", "Post Code", County, "Country/Region Code", (CurrFieldNo <> 0) AND GUIALLOWED);
            end;
        }
        ...
        field(25; "Country/Region Code"; Code[10])
        {
            ...
            trigger OnValidate()
            begin
                PostCode.CheckClearPostCodeCityCounty("City/Town", "Post Code", County, "Country/Region Code", xRec."Country/Region Code");
            end;
        }
    }
