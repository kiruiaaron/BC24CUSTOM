table 50141 "Divisional Appraisal Lines"
{
    ...
    fields
    {
        ...
        field(7; "Activity Description"; Text[150])
        {
            DataClassification = ToBeClassified;
        }
        field(8; "Activity Option"; Option)
        {
            DataClassification = ToBeClassified;
    ...
    keys
    {
        key(Key1; "Appraisal No", "Appraisal Objective", "Organization Activity Code", "Departmental Activity Code", "Activity Code")
        {
        }
    }
    ...
    fieldgroups
    {
        fieldgroup(DropDown; "Appraisal Objective", "Organization Activity Code", "Departmental Activity Code", "Activity Code", "Activity Description")
        {
        }
    }
    ...
    var
        ...
        EmployeeAppraisalLines: Record 50141;
        Results: Decimal;
        ...
        DepartmentalAppraisalLines: Record 50140;
