report 52205 "Probation Review Repor"
{
    RDLCLayout = './src/layouts/Probation Review Repor.rdlc';
    WordLayout = './src/layouts/Probation Review Repor.docx';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem("Probation Review"; 50328)
        {
            ...
            begin
                JobTitle := '';
                IF EmployeeRec.GET("Probation Review"."Employee No.") THEN
