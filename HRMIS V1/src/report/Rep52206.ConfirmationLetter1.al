report 52206 "Confirmation Letter1"
{
    RDLCLayout = './src/layouts/Confirmation Letter1.rdlc';
    WordLayout = './src/layouts/Confirmation Letter1.docx';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem("Probation Review"; 50328)
        {
            ...
            column(PostStartDate_ProbationReview; "Probation Review"."Post Start Date")
            {
            }
            ...
            dataitem("Probation Review Meeting"; 50329)
            {
                ...
                column(MeetingDate_ProbationReviewMeeting; "Probation Review Meeting"."Meeting Date")
                {
                }
            ...
            dataitem("Probation First Review"; 50332)
            {
                ...
                column(FirstReviewDate_ProbationFirstReview; "Probation First Review"."First Review Date")
                {
                }
            ...
            dataitem("Probation Final Review"; 50335)
            {
                ...
                column(NewProbationEndDate_ProbationFinalReview; "Probation Final Review"."New Probation End Date")
                {
                }
