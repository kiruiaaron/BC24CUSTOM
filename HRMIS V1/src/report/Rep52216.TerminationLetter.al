report 52216 "Termination Letter"
{
    RDLCLayout = './src/layouts/Termination Letter.rdlc';
    WordLayout = './src/layouts/Termination Letter.docx';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem("Probation Review"; 50328)
        {
            ...
            dataitem("Probation First Review"; 50332)
            {
                ...
                dataitem("Probation "; 50333)
                {
                    DataItemLink = "Review No." = FIELD("Review No.");
                    DataItemTableView = WHERE("First/Final" = CONST(First));
                    column(AreaOfPerformance_ProbationFirstFinalKPI; "Area Of Performance")
                    {
                    }
                    column(Remarks_ProbationFirstFinalKPI; Remarks)
                    {
                    }
                }
