page 50689 "Probation Review List-Final Re"
{
    Caption = 'Probation Review List-Final Review';
    CardPageID = "Probation Review Card-Final";
    PageType = List;
    UsageCategory = Lists;
    ApplicationArea = All;
    SourceTable = 50328;
    SourceTableView = WHERE("Review Stage" = FILTER("6-Month Review"));
