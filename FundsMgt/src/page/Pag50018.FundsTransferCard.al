page 50018 "Funds Transfer Card"
{
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Reference No/Cheque No"; Rec."Reference No.")
                {
                    Caption = 'Reference No/Cheque No';
                    ApplicationArea = All;
                }
            }
            part(sbpg; 50019)
    ...
    actions
    {
        area(creation)
        {
            ...
            group(Posting)
            {
                ...
                action("Print Petty Cash Reimbursmement Voucher")
                {
                    Caption = 'Print Petty Cash Reimbursmement Voucher';
                    Image = Print;
                    Promoted = true;
