    ...
    actions
    {
        area(processing)
        {
            ...
            group("Request Approval")
            {
                ...
                action("Change To Petty Cash")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Change To Petty Cash';
                    Image = ReOpen;
                    Promoted = true;
                    PromotedCategory = Category8;
                    PromotedIsBig = true;
                    ...
                    begin
                        Rec.TESTFIELD(Posted, FALSE);
                        Rec.TESTFIELD("Paid In Bank", FALSE);
                        IF NOT CONFIRM('Are you sure you want to change this application to petty cash?') THEN
                            EXIT;
            ...
            group(IncomingDocument)
            {
                ...
                action("Paid in Bank")
                {
                    ...
                    begin
                        ...
                        Rec.MODIFY;
                        MESSAGE('Imprest Marked Successfully');
                    end;
                }
                ...
                action("Post Imprest TAX")
                {
                    Caption = 'Post Imprest TAX';
                    Image = PostPrint;
                    Promoted = true;
                    PromotedCategory = Process;
                    PromotedIsBig = true;
                    ...
                    begin
                        ...
                        IF FundsUserSetup.GET(USERID) THEN BEGIN
                            ...
                            JTemplate := FundsUserSetup."Imprest Template";
                            JBatch := FundsUserSetup."Imprest Batch";
                            FundsManagement.PostAllowanceTax(Rec, JTemplate, JBatch, FALSE);
                        END ELSE BEGIN
                            ERROR(UserAccountNotSetup, USERID);
                        END;
                    end;
