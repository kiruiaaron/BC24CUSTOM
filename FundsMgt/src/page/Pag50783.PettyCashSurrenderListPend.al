page 50783 "Petty Cash Surrender List Pend"
{
    CardPageID = 50781;
    DeleteAllowed = false;
    Caption = 'Petty Cash Surrender List Pending Approval';
    PageType = List;
    UsageCategory = Lists;
    ApplicationArea = All;
    SourceTable = 50010;
    SourceTableView = WHERE(Type = filter("Petty Cash"), Posted = CONST(False),
