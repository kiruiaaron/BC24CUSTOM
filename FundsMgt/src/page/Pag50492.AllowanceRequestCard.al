page 50492 "Allowance Request Card"
{
    DeleteAllowed = false;
    PageType = Card;
    ShowFilter = false;
    ...
    actions
    {
        area(processing)
        {
            ...
            group(Posting)
            {
                ...
                action("Print Subsistence")
                {
                    Caption = 'Print Subsistence';
                    Image = Print;
                    Promoted = true;
                    ...
                    begin
                        ...
                        IF ImprestHeader.FINDFIRST THEN BEGIN
                            //    REPORT.RUNMODAL(REPORT::"Subsistence Voucher", TRUE, FALSE, ImprestHeader);
                        END;
                    end;
                }
            }
