page 50135 "Approved Cash Payment List"
{
    CardPageID = "Approved Cash Payment Card";
    DeleteAllowed = false;
    PageType = List;
    UsageCategory = Lists;
    ApplicationArea = All;
        ...
        area(processing)
        {
            ...
            group(RequestApproval)
            {
                ...
                action(Approvals)
                {
                    ...
                    begin
                        // WorkflowsEntriesBuffer.runRunWorkflowEntriesPage(RECORDID, DATABASE::"Payment Header", "Document Type", "No.");
                    end;
                }
