page 50495 "Allowance Approved List"
{
    Caption = 'Allowance Approved List';
    CardPageID = "Allowance Request Card";
    DeleteAllowed = false;
    Editable = false;
    PageType = List;
    ShowFilter = false;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Transferred to Payroll"; Rec."Transferred to Payroll")
                {
                    ApplicationArea = All;
                }
