report 51148 "Departmental Bank Payment List"
{
    DefaultLayout = RDLC;
    RDLCLayout = '.layout/Departmental Bank Payment List.rdlc';
    ...
    var
        ...
        Approved_By__Chief_Executive_OfficerCaptionLbl: Label 'Approved By: Managing Director';
        Approved_By__AccountantCaptionLbl: Label 'Approved By: Financial Accountant';
