report 51225 "Bank Payment List PV"
{
    DefaultLayout = RDLC;
    RDLCLayout = '.layout/Bank Payment List PV.rdlc';
            ...
            dataitem(Employee; 5200)
            {
                ...
                begin
                    ...
                    IF Header.GET(Periods."Period ID", Employee."No.") THEN BEGIN
                        //IF Header.GET(Periods."Period ID",Employee."Payroll Code") THEN BEGIN
                        ...
                        //CMT
                        IF Header."Payroll Code" = 'CMT' THEN
                            Amount2 := Amount;
                        IF Amount2 <= 0 THEN
                            CurrReport.SKIP
                        ELSE
                    ...
                    //GENERAL
                    IF Header."Payroll Code" = 'GENERAL' THEN
                        Amount1 := Amount;
                    IF Amount1 <= 0 THEN
                        CurrReport.SKIP
                    ELSE
