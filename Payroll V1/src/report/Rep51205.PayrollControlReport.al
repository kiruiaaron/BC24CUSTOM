report 51205 "Payroll Control Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = '.layout/Payroll Control Report.rdlc';
                    ...
                    begin
                        ...
                        IF "Calculation Scheme Master Roll"."Value Source" = "Calculation Scheme Master Roll"."Value Source"::"ED Definition" THEN BEGIN
                            ...
                            IF PayrollLines.FINDFIRST THEN BEGIN
                                ...
                                ELSE
                                    IF (PayrollLines."Calculation Group" = PayrollLines."Calculation Group"::Deduction) THEN BEGIN
                                        IF "Calculation Scheme Master Roll".Negative THEN
                                            TotalIncome := TotalIncome - Amount
                                        ELSE
