report 51198 "NITA Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = '.layout/NITA Report.rdlc';
    ...
    dataset
    {
        dataitem(Periods; 51151)
        {
            ...
            {
                DataItemTableView = SORTING("ED Code");
                ...
                dataitem("Payroll Lines"; 51160)
                {
                    ...
                    dataitem(Employee; 5200)
                    {
                        ...
                        column(AmountPeriod; PayrollSetup."Retirements Age")
                        {
                        }
                ...
                begin
                    ...
                    TotalAmountToDate := 0;
                    TotalAmount := 0;
                    TitleText := 'NITA Schedule for ' + Periods.Description;
                end;

                trigger OnPreDataItem()
                begin
                    SETRANGE("ED Code", PayrollSetup."Basic Pay E/D Code");
                end;
            }
